...
$rule_name = $model->rule ? $model->rule->name : 'full';

$this->title = Yii::t('app', 'Create Page ').'('.$rule_name.')';
...
<section class="content-header">
    <h1>
        <?= Yii::t('app', 'Create Page ').'('.$rule_name.')'; ?>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
        <li class="active"><?= Yii::t('app', 'Create Page ').'('.$rule_name.')'; ?></li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="row">
        ...
        <section class="col-lg-9 connectedSortable">
            <?= $this->render('_form_page', ['model' => $model]) ?>
        </section>
